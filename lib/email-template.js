...
<table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;background:#ffffff;">
  ...
  <tr>
    <td bgcolor="${INK_DEEP}" align="center" style="background-color:${INK_DEEP};padding:22px 32px;">
      <table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center" style="margin:0 auto;">
        <tr>
          <td bgcolor="${GOLD}" align="center" valign="middle" width="40" height="40" style="background-color:${GOLD};width:40px;height:40px;border-radius:9px;font-family:${FONT};font-size:16px;font-weight:700;color:#ffffff;letter-spacing:0.5px;line-height:40px;">MD</td>
          <td valign="middle" bgcolor="${INK_DEEP}" style="background-color:${INK_DEEP};padding-left:12px;font-family:${FONT};font-size:21px;font-weight:700;color:#ffffff;line-height:40px;">Build</td>
        </tr>
      </table>
    </td>
  </tr>
